    ...
    <template #form>
      <el-form ref="form" :model="filterForm" inline>
        <el-form-item label="仓库编号">
          <el-input
            v-model="filterForm.warehouseNo"
            placeholder="仓库编号"
          ></el-input>
        </el-form-item>
        <el-form-item label="详细地址">
          <el-input
            v-model="filterForm.detailedAddress"
            placeholder="详细地址"
          ></el-input>
        </el-form-item>
        <el-form-item>
...
import { warehousePage, warehouseDelete } from "@/api/storeModule/warehouse";
...
export default defineComponent({
  ...
  setup() {
    ...
    const getList = () => {
      warehousePage(filterForm.value).then(({ data }) => {
    ...
    const runToEdit = (query?:Obj) => {
      router.push({path:'/warehouseEdit', query})
    }
